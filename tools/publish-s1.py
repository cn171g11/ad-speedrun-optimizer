"""Publish an explicit file set using the existing local credential provider."""
import argparse
import base64
...
FILES = ["js/model.js", "js/s1sim.js", "js/s1route.js", "js/s1flow.js", "js/s1render.js", "js/s1data.js",
         "stage2-s1.html", "s1.css", "tools/s1-audit.cjs", "tools/publish-s1.py"]
...
def publish(provider, expected_parent, message):
    ...
    commit = provider.call("POST", prefix + "/git/commits", {
        "message": message, "tree": tree["sha"], "parents": [current]})
...
if __name__ == "__main__":
    ...
    publish(load_provider(arguments.provider), arguments.expected_parent, arguments.message)
